package org.ycm.config.mybatis.aspect;
...
import org.ycm.common.aspect.annotation.DynamicTable;
import org.ycm.common.constant.CommonConstant;
import org.ycm.common.util.SpringContextUtils;
import org.ycm.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(org.ycm.common.aspect.annotation.DynamicTable)")
