...
import org.ycm.config.JeecgBaseConfig;
import org.ycm.config.shiro.filters.CustomShiroFilterFactoryBean;
import org.ycm.config.shiro.filters.JwtFilter;
...
@ComponentScan(basePackages = {"org.ycm.**.controller"})
